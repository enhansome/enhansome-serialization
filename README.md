...
* [Protocol Buffers](https://github.com/protocolbuffers/protobuf) ⭐ 72,057 | 🐛 497 | 🌐 C++ | 📅 2026-09-23 - Google's data interchange format. Binary.
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,620 | 🐛 7 | 📅 2026-09-15 - Tom's Obvious, Minimal Language. Textual.
...
* [TOON](https://github.com/toon-format/toon) ⭐ 25,417 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-03 - Token-Oriented Object Notation. Compact, schema-aware JSON alternative achieving 30–60% token savings for LLM prompts. Textual.
...
* [A2A](https://github.com/a2aproject/A2A) ⭐ 25,898 | 🐛 258 | 🌐 Shell | 📅 2026-09-22 - Agent2Agent Protocol. Google's open protocol for agent-to-agent communication and interoperability. JSON based. Textual.
...
* [BAML](https://github.com/BoundaryML/baml) ⭐ 9,265 | 🐛 354 | 🌐 Rust | 📅 2026-09-23 - Boundary AI Markup Language. Domain-specific language for defining LLM function signatures with type-safe structured output. Textual.

### **Machine Learning**

Serialization of deep learning networks and weights.

* [GGUF](https://github.com/ggerganov/ggml/blob/master/docs/gguf.md) ⭐ 15,395 | 🐛 365 | 🌐 C++ | 📅 2026-09-22 - Quantized model format for llama.cpp/ggml. The de facto standard for local LLM inference. Binary.
...
* [safetensors](https://github.com/huggingface/safetensors) ⭐ 3,899 | 🐛 96 | 🌐 Rust | 📅 2026-09-22 - Safe serialization of tensors for machine learning. Binary.
...
* [avsc](https://github.com/mtth/avsc) ⭐ 1,387 | 🐛 30 | 🌐 JavaScript | 📅 2026-02-22 - JavaScript implementation of Apache Avro. Textual.
