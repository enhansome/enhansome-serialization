...
* [Protocol Buffers](https://github.com/protocolbuffers/protobuf) ⭐ 72,012 | 🐛 325 | 🌐 C++ | 📅 2026-09-10 - Google's data interchange format. Binary.
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,609 | 🐛 8 | 📅 2026-09-02 - Tom's Obvious, Minimal Language. Textual.
...
* [TOON](https://github.com/toon-format/toon) ⭐ 25,346 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-03 - Token-Oriented Object Notation. Compact, schema-aware JSON alternative achieving 30–60% token savings for LLM prompts. Textual.
...
* [A2A](https://github.com/a2aproject/A2A) ⭐ 25,705 | 🐛 248 | 🌐 Shell | 📅 2026-09-04 - Agent2Agent Protocol. Google's open protocol for agent-to-agent communication and interoperability. JSON based. Textual.
...
* [BAML](https://github.com/BoundaryML/baml) ⭐ 9,162 | 🐛 328 | 🌐 Rust | 📅 2026-09-10 - Boundary AI Markup Language. Domain-specific language for defining LLM function signatures with type-safe structured output. Textual.

### **Machine Learning**

Serialization of deep learning networks and weights.

* [GGUF](https://github.com/ggerganov/ggml/blob/master/docs/gguf.md) ⭐ 15,324 | 🐛 360 | 🌐 C++ | 📅 2026-09-09 - Quantized model format for llama.cpp/ggml. The de facto standard for local LLM inference. Binary.
...
* [safetensors](https://github.com/huggingface/safetensors) ⭐ 3,891 | 🐛 82 | 🌐 Rust | 📅 2026-09-09 - Safe serialization of tensors for machine learning. Binary.
...
* [avsc](https://github.com/mtth/avsc) ⭐ 1,386 | 🐛 30 | 🌐 JavaScript | 📅 2026-02-22 - JavaScript implementation of Apache Avro. Textual.
* [BSON.js](https://github.com/mongodb/js-bson) ⭐ 1,216 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-09 - BSON serializer. Binary.

#### **Dart**

* [Dart Object Serialization](https://github.com/flutter/packages/tree/main/packages/standard_message_codec) ⭐ 5,304 | 🐛 226 | 🌐 Dart | 📅 2026-09-10 - RAM to Disk serialization. Dart-specific. Binary.

#### **Python**

* [msgpack-python](https://github.com/msgpack/msgpack-python) ⭐ 2,102 | 🐛 15 | 🌐 Python | 📅 2026-09-07 - MessagePack serializer implementation for Python.
