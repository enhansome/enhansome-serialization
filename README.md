...
* [Protocol Buffers](https://github.com/protocolbuffers/protobuf) ⭐ 71,773 | 🐛 312 | 🌐 C++ | 📅 2026-08-22 - Google's data interchange format. Binary.
...
* [TOON](https://github.com/toon-format/toon) ⭐ 25,217 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-07 - Token-Oriented Object Notation. Compact, schema-aware JSON alternative achieving 30–60% token savings for LLM prompts. Textual.
...
* [A2A](https://github.com/a2aproject/A2A) ⭐ 25,448 | 🐛 236 | 🌐 Shell | 📅 2026-08-21 - Agent2Agent Protocol. Google's open protocol for agent-to-agent communication and interoperability. JSON based. Textual.

#### Structured Output

Formats and schemas for constraining and validating LLM-generated structured data.

* [BAML](https://github.com/BoundaryML/baml) ⭐ 9,060 | 🐛 310 | 🌐 Rust | 📅 2026-08-21 - Boundary AI Markup Language. Domain-specific language for defining LLM function signatures with type-safe structured output. Textual.
...
* [GGUF](https://github.com/ggerganov/ggml/blob/master/docs/gguf.md) ⭐ 15,214 | 🐛 352 | 🌐 C++ | 📅 2026-08-21 - Quantized model format for llama.cpp/ggml. The de facto standard for local LLM inference. Binary.
...
* [safetensors](https://github.com/huggingface/safetensors) ⭐ 3,863 | 🐛 73 | 🌐 Rust | 📅 2026-08-21 - Safe serialization of tensors for machine learning. Binary.
...
* [Dart Object Serialization](https://github.com/flutter/packages/tree/main/packages/standard_message_codec) ⭐ 5,288 | 🐛 144 | 🌐 Dart | 📅 2026-08-21 - RAM to Disk serialization. Dart-specific. Binary.
