# awesome-serialization with stars

> So many formats, so much wow. *See [wesm](https://github.com/18F/data-act-pilot/issues/161#issuecomment-139812420) ⚠️ Archived comment before making up your mind.*
...
* [Protocol Buffers](https://github.com/protocolbuffers/protobuf) ⭐ 72,056 | 🐛 493 | 🌐 C++ | 📅 2026-09-22 - Google's data interchange format. Binary.
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,621 | 🐛 7 | 📅 2026-09-15 - Tom's Obvious, Minimal Language. Textual.
...
* [TOON](https://github.com/toon-format/toon) ⭐ 25,407 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-03 - Token-Oriented Object Notation. Compact, schema-aware JSON alternative achieving 30–60% token savings for LLM prompts. Textual.
...
* [A2A](https://github.com/a2aproject/A2A) ⭐ 25,885 | 🐛 262 | 🌐 Shell | 📅 2026-09-21 - Agent2Agent Protocol. Google's open protocol for agent-to-agent communication and interoperability. JSON based. Textual.
...
* [BAML](https://github.com/BoundaryML/baml) ⭐ 9,251 | 🐛 360 | 🌐 Rust | 📅 2026-09-22 - Boundary AI Markup Language. Domain-specific language for defining LLM function signatures with type-safe structured output. Textual.

### **Machine Learning**

Serialization of deep learning networks and weights.

* [GGUF](https://github.com/ggerganov/ggml/blob/master/docs/gguf.md) ⭐ 15,385 | 🐛 365 | 🌐 C++ | 📅 2026-09-21 - Quantized model format for llama.cpp/ggml. The de facto standard for local LLM inference. Binary.
...
* [safetensors](https://github.com/huggingface/safetensors) ⭐ 3,899 | 🐛 96 | 🌐 Rust | 📅 2026-09-21 - Safe serialization of tensors for machine learning. Binary.
...
* [avsc](https://github.com/mtth/avsc) ⭐ 1,388 | 🐛 30 | 🌐 JavaScript | 📅 2026-02-22 - JavaScript implementation of Apache Avro. Textual.
* [BSON.js](https://github.com/mongodb/js-bson) ⭐ 1,217 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-21 - BSON serializer. Binary.

#### **Dart**

* [Dart Object Serialization](https://github.com/flutter/packages/tree/main/packages/standard_message_codec) ⭐ 5,310 | 🐛 250 | 🌐 Dart | 📅 2026-09-22 - RAM to Disk serialization. Dart-specific. Binary.

#### **Python**

* [msgpack-python](https://github.com/msgpack/msgpack-python) ⭐ 2,103 | 🐛 14 | 🌐 Python | 📅 2026-09-22 - MessagePack serializer implementation for Python.
* [srsly](https://github.com/explosion/srsly) ⭐ 487 | 🐛 11 | 🌐 Python | 📅 2026-03-27 - Modern high-performance serialization utilities for Python.
* [pickle](https://docs.python.org/3/library/pickle.html) - RAM to Disk serialization. Binary.

#### **Swift**

* [MessagePack.swift](https://github.com/a2/MessagePack.swift) ⭐ 291 | 🐛 7 | 🌐 Swift | 📅 2020-06-09 - Swift MessagePack Serializer.
...
* [bincode](https://github.com/bincode-org/bincode) ⚠️ Archived - High-performance binary serialization for Rust.
