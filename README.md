...
* [Protocol Buffers](https://github.com/protocolbuffers/protobuf) ⭐ 72,000 | 🐛 314 | 🌐 C++ | 📅 2026-09-07 - Google's data interchange format. Binary.
...
* [TOON](https://github.com/toon-format/toon) ⭐ 25,332 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-03 - Token-Oriented Object Notation. Compact, schema-aware JSON alternative achieving 30–60% token savings for LLM prompts. Textual.
...
* [A2A](https://github.com/a2aproject/A2A) ⭐ 25,666 | 🐛 246 | 🌐 Shell | 📅 2026-09-04 - Agent2Agent Protocol. Google's open protocol for agent-to-agent communication and interoperability. JSON based. Textual.
...
* [BAML](https://github.com/BoundaryML/baml) ⭐ 9,145 | 🐛 324 | 🌐 Rust | 📅 2026-09-07 - Boundary AI Markup Language. Domain-specific language for defining LLM function signatures with type-safe structured output. Textual.

### **Machine Learning**

Serialization of deep learning networks and weights.

* [GGUF](https://github.com/ggerganov/ggml/blob/master/docs/gguf.md) ⭐ 15,299 | 🐛 358 | 🌐 C++ | 📅 2026-09-04 - Quantized model format for llama.cpp/ggml. The de facto standard for local LLM inference. Binary.
...
* [safetensors](https://github.com/huggingface/safetensors) ⭐ 3,887 | 🐛 79 | 🌐 Rust | 📅 2026-08-27 - Safe serialization of tensors for machine learning. Binary.
...
* [Dart Object Serialization](https://github.com/flutter/packages/tree/main/packages/standard_message_codec) ⭐ 5,303 | 🐛 220 | 🌐 Dart | 📅 2026-09-06 - RAM to Disk serialization. Dart-specific. Binary.
