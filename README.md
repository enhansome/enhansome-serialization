...
* [Protocol Buffers](https://github.com/protocolbuffers/protobuf) ⭐ 72,032 | 🐛 348 | 🌐 C++ | 📅 2026-09-12 - Google's data interchange format. Binary.
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,611 | 🐛 6 | 📅 2026-09-11 - Tom's Obvious, Minimal Language. Textual.
...
* [TOON](https://github.com/toon-format/toon) ⭐ 25,364 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-03 - Token-Oriented Object Notation. Compact, schema-aware JSON alternative achieving 30–60% token savings for LLM prompts. Textual.
...
* [A2A](https://github.com/a2aproject/A2A) ⭐ 25,740 | 🐛 250 | 🌐 Shell | 📅 2026-09-11 - Agent2Agent Protocol. Google's open protocol for agent-to-agent communication and interoperability. JSON based. Textual.
...
* [BAML](https://github.com/BoundaryML/baml) ⭐ 9,170 | 🐛 331 | 🌐 Rust | 📅 2026-09-12 - Boundary AI Markup Language. Domain-specific language for defining LLM function signatures with type-safe structured output. Textual.

### **Machine Learning**

Serialization of deep learning networks and weights.

* [GGUF](https://github.com/ggerganov/ggml/blob/master/docs/gguf.md) ⭐ 15,341 | 🐛 361 | 🌐 C++ | 📅 2026-09-09 - Quantized model format for llama.cpp/ggml. The de facto standard for local LLM inference. Binary.
...
* [safetensors](https://github.com/huggingface/safetensors) ⭐ 3,892 | 🐛 85 | 🌐 Rust | 📅 2026-09-09 - Safe serialization of tensors for machine learning. Binary.
...
* [BSON.js](https://github.com/mongodb/js-bson) ⭐ 1,216 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-11 - BSON serializer. Binary.

#### **Dart**

* [Dart Object Serialization](https://github.com/flutter/packages/tree/main/packages/standard_message_codec) ⭐ 5,305 | 🐛 232 | 🌐 Dart | 📅 2026-09-12 - RAM to Disk serialization. Dart-specific. Binary.

#### **Python**

* [msgpack-python](https://github.com/msgpack/msgpack-python) ⭐ 2,103 | 🐛 15 | 🌐 Python | 📅 2026-09-07 - MessagePack serializer implementation for Python.
* [srsly](https://github.com/explosion/srsly) ⭐ 487 | 🐛 9 | 🌐 Python | 📅 2026-03-27 - Modern high-performance serialization utilities for Python.
